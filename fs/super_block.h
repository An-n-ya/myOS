#ifndef OS_LEARN_SUPER_BLOCK_H
#define OS_LEARN_SUPER_BLOCK_H
#include "global.h"
struct super_block {
    uint32_t magic;             // 用来表示文件系统的类型，本系统使用类似ext2的结构
    ...
    uint8_t pad[460];           // pad之前所有变量大小为52字节，加上470字节，凑够512字节1扇区大小
}__attribute__((packed));

#endif //OS_LEARN_SUPER_BLOCK_H
